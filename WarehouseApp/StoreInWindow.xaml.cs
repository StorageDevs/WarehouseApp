            ...
            try
            {
                ...
                if (materialsResponse.IsSuccessStatusCode)
                {
                    ...
                    if (result?.Result != null)
                    {
                        ...
                        cmbMaterials.DisplayMemberPath = "MaterialDescription";
                    }
                }

                // Locations lekérdezés
                ...
                if (locationsResponse.IsSuccessStatusCode)
                {
                    ...
                    if (result?.Result != null)
                    {
                        ...
                        cmbLocations.ItemsSource = _locations
                            ...
                            .ToList();
                        cmbLocations.DisplayMemberPath = "LocationName";
                    }
                }

                // Inventories lekérdezés
                ...
                // Inicializáljuk a spinner értékét
                numQuantity.Value = 1;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Hiba a betöltés során: " + ex.Message, "Hiba", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
